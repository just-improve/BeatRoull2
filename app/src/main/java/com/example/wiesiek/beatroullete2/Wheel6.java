...
public class Wheel6  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel6");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col6);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col6);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col6);
    }
}
