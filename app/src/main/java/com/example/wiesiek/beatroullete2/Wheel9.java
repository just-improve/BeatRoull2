...
public class Wheel9  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel9");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col9);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col9);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col9);
    }
}
