...
public class Wheel4  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel4");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col4);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col4);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col4);
    }
}
