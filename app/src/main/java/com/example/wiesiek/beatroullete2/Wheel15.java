...
public class Wheel15 extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel15");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col15);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col15);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col15);
    }
}
