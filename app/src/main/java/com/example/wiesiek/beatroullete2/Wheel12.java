...
/**
 * Created by Wiesiek on 2017-08-25.
 */

public class Wheel12 extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel12");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col12);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col12);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col12);
    }
}
