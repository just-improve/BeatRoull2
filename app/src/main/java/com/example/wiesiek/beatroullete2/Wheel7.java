...
public class Wheel7  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel7");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col7);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col7);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col7);
    }
}
