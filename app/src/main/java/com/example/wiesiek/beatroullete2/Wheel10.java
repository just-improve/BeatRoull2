...
public class Wheel10  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel10");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col10);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col10);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col10);
    }
}
