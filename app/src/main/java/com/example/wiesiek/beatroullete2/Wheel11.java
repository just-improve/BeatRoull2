...
public class Wheel11 extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel11");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col11);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col11);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col11);
    }
}
