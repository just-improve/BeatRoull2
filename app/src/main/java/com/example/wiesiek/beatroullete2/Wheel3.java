...
public class Wheel3  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel3");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col3);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col3);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col3);
    }
}
