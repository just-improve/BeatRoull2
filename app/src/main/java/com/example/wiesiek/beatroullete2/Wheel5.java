...
public class Wheel5  extends BaseClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetExtraFromIntent("wheel5");
        DatabaseAndSetSelection(ManagerDatabase.DatabaseClass.Col5);
    ...
    protected void onStop() {
        ...
        managerDatabase.DeleteColumn(ManagerDatabase.DatabaseClass.Col5);
        managerDatabase.AddData(edStr, ManagerDatabase.DatabaseClass.Col5);
    }
}
